...
<div class="card-footer">
    <button type="button" id="btnPrint" class="btn btn-sm bg-gradient-success"><span
    ...
    <button class="btn btn-sm bg-gradient-danger" id="tutup" data-dismiss="modal"><span
            class="fa fa-times-circle"></span>&nbsp;&nbsp; Tutup</button>