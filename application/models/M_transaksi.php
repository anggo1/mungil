...
public function select_by_pengiriman($id) {
    ...
    public function insertjual($data) {
        $date= date("Y-m-d");
		$potongan = '';
		if($data['harga']=='harga_eceran'){
				$ci = get_instance();
				$q_stok= "SELECT harga_eceran AS harganya,
				stok AS stok_akhir,
				nama_barang AS nama_barang,
				nama_satuan AS satuan
				FROM tbl_barang LEFT JOIN tbl_satuan ON tbl_satuan.id_satuan=tbl_barang.id_satuan
				...
				if($bentuk_promo =='P'){			
					...
					//$diskon = $data_stok['harganya'] * $nilai_promo/100;
					//$harga  = $harga-$diskon;
			...
			$bentuk_harga = $data['harga'];
			$ci = get_instance();
				$q_stok= "SELECT $bentuk_harga AS harganya,
				stok AS stok_akhir,
				nama_barang AS nama_barang,
				nama_satuan AS satuan
				FROM tbl_barang LEFT JOIN tbl_satuan ON tbl_satuan.id_satuan=tbl_barang.id_satuan
    ...
    public function select_harga() {
		$sql = " SELECT tbl_barang.kode_barang,tbl_barang.nama_barang,tbl_barang.stok,tbl_barang.harga_karton,tbl_barang.harga_eceran,
		tbl_barang.harga_grosir,tbl_barang.harga_gofood,
		tbl_barang.harga_grabfood,tbl_barang.harga_shopee,
		tbl_barang.harga_tokped,tbl_barang.harga_reseller,tbl_barang.harga_lainnya,
