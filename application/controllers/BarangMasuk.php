...
class BarangMasuk extends MY_Controller {
	public function __construct() {
		...
		$this->load->model('Mod_barang_masuk');
		...
		//$data['dPenjualan'] = $this->Mod_barang_masuk->select_penjualan();
		...
		//$data['dataSatuan'] = $this->Mod_barang_masuk->select_satuan();
		...
		$this->template->load('layoutbackend', 'transaksi/barang_masuk', $data);
	...
	$id=$_GET['kode_barang'];
	{
		$data['dataNama'] 	= $this->Mod_barang_masuk->cari_detail_barang($id);
    ...
    public function prosesMasuk() {
		...
		if ($this->form_validation->run() == TRUE) {
			$result = $this->Mod_barang_masuk->insertBarang($data);
    ...
    public function Out() {
		...
		$data['dataSup']        = $this->Mod_barang_masuk->select_supplier();
		//$data['dPenjualan'] = $this->Mod_barang_masuk->select_penjualan();
		//$data['dataDokter'] = $this->M_pendaftaran->select_dokter();
		//$data['dataDiagnosa'] = $this->M_mastermedis->select_diagnosa();
		//$data['dataFinger'] = $this->M_pendaftaran->get_data_absen();
     ...
     public function prosesKeluar() {
		...
		$data 	= $this->input->post();
		if ($this->form_validation->run() == TRUE) {
			$result = $this->Mod_barang_masuk->outBarang($data);
    ...
    public function list_keluar() {
		$id 				= $_GET['datakode'];
		$data['dataKeluar'] = $this->Mod_barang_masuk->select_keluar($id);
...
//Setoran
	...
	public function tampilJab() {
		$data['dataJabatan'] = $this->Mod_barang_masuk->select_jabatan();
	...
	public function prosesTjabatan() {
		...
		$data 	= $this->input->post();
		if ($this->form_validation->run() == TRUE) {
			$result = $this->Mod_barang_masuk->insertJabatan($data);
	...
	public function updateJabatan() {
		$data['userdata'] 	= $this->userdata;
		$id 				= trim($_POST['id']);
		$data['dataJabatan'] = $this->Mod_barang_masuk->select_id_jabatan($id);
	...
	public function prosesUjabatan() {
		...
		$data 	= $this->input->post();
		if ($this->form_validation->run() == TRUE) {
			$result = $this->Mod_barang_masuk->update_jabatan($data);
